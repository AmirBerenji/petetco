...
export default function Home() {
  return (
    ...
    <div className="w-screen h-screen grid  bg-zinc-100 ">
      <div className='grid  grid-cols-2 '>
        <div></div>
        <div>
          <Image src="/assets/circelPink.png" width="560" height="560" alt="hero 1"/>
        </div>
      </div>
      ...
      <div className='grid  grid-cols-2 '>
        <div></div>
        <div>
          <Image src="/assets/circulePurpel.png" width="500" height="500" alt="hero 1" className="absolute bottom-0 right-32 hidden lg:block" />
        </div>
      </div>
